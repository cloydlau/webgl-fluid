...
<p align="center">
  ...
  <a href="https://npm-stat.com/charts.html?package=webgl-fluid&from=2020-11-14"><img alt="npm downloads" src="https://img.shields.io/npm/dt/webgl-fluid?label=npm&color=cb3837"></a>
  <br>
...
<html lang="en">
  ...
  <body>
    ...
    <script type="importmap">
      {
        "imports": {
          "webgl-fluid": "https://cdn.jsdelivr.net/npm/webgl-fluid@0.4/dist/webgl-fluid.mjs"
        }
      }
    </script>
    <script type="module">
